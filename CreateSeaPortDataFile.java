package code;// File: code.CreateSeaPortDataFile.java
// Date: Jul 8, 2016
...
} // end class code.CreateSeaPortDataFile
...
class MyThing implements Comparable <MyThing> {
   ...
   void readSkillsFile () {
      try {
         ...
         Scanner sp = new Scanner (new File ("src/code/skillNames.txt"));
   ...
   public String toFileString () {
      return "";
   } // default toFileString method in code.MyThing
} // end class code.MyThing
...
class MySeaPort extends MyThing {
   ...
   void readPortsFile () {
      try {
         ...
         Scanner sp = new Scanner (new File ("src/code/portNames.txt"));


         while (sp.hasNext()) portNames.add (sp.next());
         System.out.println ("Ports file size: " + portNames.size());  
      } 
      catch (java.io.FileNotFoundException e) {System.out.println ("port file");}
...
class MyShip extends MyThing {
   ...
   void readWordsFile () {
      try {
         words = new ArrayList <> ();
         Scanner sp = new Scanner (new File ("src/code/shipNames.txt"));
...
} // end class code.MyPassengerShip
...
class MyPerson extends MyThing {
   ...
   void readNamesFile () {
      try {
         words = new ArrayList <> ();
         Scanner sp = new Scanner (new File ("src/code/personNames.txt"));
         while (sp.hasNext()) words.add (sp.next());
